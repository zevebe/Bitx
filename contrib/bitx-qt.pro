...
RESOURCES += src/qt/bitx.qrc src/qt/bitx_locale.qrc

TRANSLATIONS += src/qt/locale/bitx_bg.ts \
                src/qt/locale/bitx_de.ts \
                src/qt/locale/bitx_en.ts \
                src/qt/locale/bitx_es.ts \
                src/qt/locale/bitx_fi.ts \
                src/qt/locale/bitx_fr.ts \
                src/qt/locale/bitx_it.ts \
                src/qt/locale/bitx_ja.ts \
                src/qt/locale/bitx_pl.ts \
                src/qt/locale/bitx_pt.ts \
                src/qt/locale/bitx_ru.ts \
                src/qt/locale/bitx_sk.ts \
                src/qt/locale/bitx_sv.ts \
                src/qt/locale/bitx_vi.ts \
                src/qt/locale/bitx_zh_CN.ts \
                src/qt/locale/bitx_zh_TW.ts
