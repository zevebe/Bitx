...
from fake_stake.base_test import Bitx_FakeStakeTest

class zBXwrappedSerialsTest(Bitx_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBXs..." % DENOM_TO_USE)
