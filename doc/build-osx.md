...
1. Clone the Bitx Core source code:

        git clone https://github.com/bitx-project/bitx
        cd bitx
...
Bitx Core is now available at `./src/bitxd`
...
The first time you run bitxd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/bitxd -daemon # Starts the bitx daemon.
    ./src/bitx-cli --help # Outputs a list of command-line options.
    ./src/bitx-cli help # Outputs a list of RPC commands when the daemon is running.
