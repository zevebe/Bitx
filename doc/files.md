...
bitx.conf           | contains configuration settings for bitxd or bitx-qt
bitxd.pid           | stores the process id of bitxd while running
...
debug.log           | contains debug information and general logging generated by bitxd or bitx-qt
