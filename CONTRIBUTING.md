Contributing to Bitx Core
============================

The Bitx Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bitx-project/bitx/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Bitx Core project, and is not to be
confused with overall Bitx Network Protocol consensus changes.

Whether a pull request is merged into Bitx Core rests with the project merge
...
Patches that change Bitx consensus rules are considerably more involved than
...
Where a patchset proposes to change the Bitx consensus, it must have been
...
The project leader is the release manager for each Bitx Core release.
