...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitx Core bitx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitx transaction") + "\n" +
                               "  bitx-tx [options] -create [commands]   " + _("Create hex-encoded bitx transaction") + "\n" +
                               "\n";
