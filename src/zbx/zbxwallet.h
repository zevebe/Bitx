...
#ifndef Bitx_ZBXWALLET_H
#define Bitx_ZBXWALLET_H
...
public:
    CzBXWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBX(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBX(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
