...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::BX);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeBitxAmount"))
        SoftSetArg("-anonymizebitxamount", settings.value("nAnonymizeBitxAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in bitx.cpp during shotdown to also remove the window positions
