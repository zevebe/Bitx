                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBXPathCustom = GetArg("-zbxbackuppath", "");
    ...
    if(!strzBXPathCustom.empty()) {
        ui->wallet_customzbxbackuppath->setText(QString::fromStdString(strzBXPathCustom));
        ui->wallet_customzbxbackuppath_label->setVisible(true);
        ui->wallet_customzbxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBXPathCustom.empty()) && nCustomBackupThreshold > 0) {
