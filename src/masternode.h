...
#define MASTERNODE_MIN_CONFIRMATIONS 100
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 BX, signature to prove
