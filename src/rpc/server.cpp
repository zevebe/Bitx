...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bitx features */
        {"bitx", "listmasternodes", &listmasternodes, true, true, false},
        {"bitx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitx", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitx", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitx", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitx", "masternodedebug", &masternodedebug, true, true, false},
        {"bitx", "startmasternode", &startmasternode, true, true, false},
        {"bitx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitx", "preparebudget", &preparebudget, true, true, false},
        {"bitx", "submitbudget", &submitbudget, true, true, false},
        {"bitx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitx", "checkbudgets", &checkbudgets, true, true, false},
        {"bitx", "mnsync", &mnsync, true, true, false},
        {"bitx", "spork", &spork, true, true, false},
        {"bitx", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbxseed", &getzbxseed, false, false, true},
        {"zerocoin", "setzbxseed", &setzbxseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbx", &searchdzbx, false, false, true},
        {"zerocoin", "dzbxstate", &dzbxstate, false, false, true},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15369/\n";
}
