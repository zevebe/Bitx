...
extern UniValue DoZbxSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzbxseed(const UniValue& params, bool fHelp);
extern UniValue getzbxseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbx(const UniValue& params, bool fHelp);
extern UniValue dzbxstate(const UniValue& params, bool fHelp);
